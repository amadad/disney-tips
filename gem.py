...
from gemini.models import Prompt, Response
...
def fetch_video_data(url):
    try:
        ...
        # Use Gemini API to process transcript
        gemini = Gemini()
        prompt = Prompt(text=transcript_text)
        response: Response = gemini.generate_text(prompt)
        trip_tips = disney_world_assistant.parse_output(response.text)
