...
- [ ] 1.1 Add `escapeXml()` helper function to `extract-tips.ts` for XML character escaping
- [ ] 1.2 Add `formatRfc822Date()` helper to convert ISO dates to RFC 822 format
...
- [ ] 3.1 Run `npm run extract` and verify `data/public/feed.xml` is created
- [ ] 3.2 Validate feed XML using online validator (e.g., validator.w3.org/feed)
